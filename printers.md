...
| SPRT SP-L36 |80mm|0.2.8|<ul> <li> Barcode no working code 128  <li> barcode paramter error printed  <li> unhandled exception when printing space </ul> (Tested on Android) |
